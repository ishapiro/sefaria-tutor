      ...
      >
        <div class="bg-white rounded-lg shadow-xl p-6 max-w-2xl mx-4 text-left max-h-[90vh] overflow-y-auto">
          ...
          <section class="mb-5">
            ...
            <p class="text-gray-700 text-sm mb-2">
              <strong>Translations:</strong> Word-by-word analysis and translations are generated by <a href="https://openai.com/" target="_blank" rel="noopener" class="text-blue-600 hover:underline">OpenAI</a>'s GPT models. Sefaria.org does not provide the translations shown here.
            </p>
